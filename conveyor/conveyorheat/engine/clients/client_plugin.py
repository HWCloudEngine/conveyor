...
class ClientPlugin(object):
    ...
    def auth_token(self):
        ...
        # keystoneclient.
        return (self.context.iam_assume_token or
                self.context.auth_plugin.get_token(self._keystone_session))
    ...
    def url_for(self, **kwargs):
        ...
        try:
            ...
            admin_client = self.clients.client('keystone').admin_client
            admin_url = admin_client.service_catalog.url_for(**kwargs)
            admin_project_id = admin_client.auth_ref.project_id
            user_project_id = self.context.tenant_id
            url = admin_url.replace(admin_project_id, user_project_id)
