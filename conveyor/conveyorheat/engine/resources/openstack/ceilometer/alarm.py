...
NOVA_METERS = ['instance', 'memory', 'memory.usage', 'mem_util',
               'cpu', 'cpu_util', 'cpu_util.inband', 'vcpus',
               ...
               'disk.root.size', 'disk.ephemeral.size', 'disk_util.inband',
               'network.incoming.bytes', 'network.incoming.bytes.rate',
               'network.incoming.bytes.inband',
               'network.incoming.bytes.rate.inband',
               'network.outgoing.bytes.inband',
               'network.outgoing.bytes.rate.inband',
