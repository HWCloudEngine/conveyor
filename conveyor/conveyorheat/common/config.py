...
default_clients_opts = [
    ...
    cfg.IntOpt('timeout',
               default=60,
               help=_("Timeout in seconds for client call, set to 0 to "
                      "disable"))
]
...
cfg.CONF.register_opts(iam_opts, group='iam_authtoken')
...
ces_client_opts = [
    cfg.StrOpt('url',
               default='',
               help=_('Optional heat url in format like'
                      ' http://0.0.0.0:5000/V1.0/%(tenant_id)s.'))]

groupwatch_client_opts = [
    cfg.StrOpt('url',
               default='',
               help=_('Optional heat url in format like'
                      ' http://0.0.0.0:5000/V1.0/%(tenant_id)s.'))]

sheduler_client_opts = [
    cfg.StrOpt('url',
               default='',
               help=_('Optional heat url in format like'
                      ' http://0.0.0.0:5000/V1.0/%(tenant_id)s.'))]
...
fusionsphere_group = cfg.OptGroup('FusionSphere')
fusionsphere_opts = [
    cfg.BoolOpt('groupwatch_enable',
                default=False,
                help=_('Enable groupwatch. '
                       'If you use CES for alarm, you must set '
                       'groupwatch_enable to True')),
    cfg.StrOpt('heat_orchestration_url',
               default='https://orchestration.localdomain.com:8700/v1',
               help=_('Heat host for a stack.')),
    cfg.BoolOpt('pubcloud',
                default=False,
                help=_('Public Cloud environment supported.')),
    cfg.StrOpt('support_resources_conf_file',
               default='/etc/heat/support_resources.conf',
               help="Support resource configure file."),
    cfg.BoolOpt('filter_resource',
                default=False,
                help="Filter resource flag.")
]
