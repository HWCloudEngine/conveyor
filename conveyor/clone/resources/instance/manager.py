...
migrate_manager_opts = [
    cfg.StrOpt('instance_clone_driver',
               default='conveyor.clone.resources.instance.driver.stack_template.StackTemplateCloneDriver',
               help='clone driver')             
]
...
class CloneManager(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.clone_driver = importutils.import_object(CONF.instance_clone_driver)
    ...
    def start_template_clone(self, context, resource_name, instance):
        ...
        try:
            self.clone_driver.start_template_clone(context, resource_name, instance,
                                               ...
                                               create_instance_wait_fun=self.resource_common._await_instance_create,
                                               port_wait_fun=self.resource_common._await_port_status,
                                               trans_data_wait_fun=self.resource_common._await_data_trans_status)
