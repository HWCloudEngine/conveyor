...
from conveyor.i18n import _LE, _LI, _LW
import conveyor.policy
...
class ExtensionManager(object):
    ...
    See conveyor/tests/api/extensions/foxinsocks/extension.py for an
...
class ControllerExtension(object):
    """Extend core controllers of conveyor OpenStack API.

    Provide a way to extend existing conveyor OpenStack API core
    controllers.
    """
...
class ResourceExtension(object):
    """Add top level resources to the OpenStack API in conveyor."""
...
def extension_authorizer(api_name, extension_name):
    def authorize(context, target=None, action=None):
        ...
        conveyor.policy.enforce(context, act, target)
    return authorize
