...
class EngineClient(object):
    ...
    def __init__(self):
        target = messaging.Target(topic=ENGINE_TOPIC,
                                  version=self.BASE_RPC_API_VERSION)
        self._client = rpc.get_client(target, serializer=None)
    ...
    def delete_stack(self, ctxt, stack_identity, is_heat_stack=False, cast=True):
