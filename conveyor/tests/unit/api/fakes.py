...
from conveyor.api.middleware import auth
from conveyor.api.middleware import fault
from conveyor.api.openstack import api_version_request as api_version
from conveyor.api.v1 import router
from conveyor.api.wsgi import wsgi as os_wsgi
from conveyor.tests.unit import fake_constants as fake

from conveyor.api import urlmap
from conveyor.api import versions
...
class HTTPRequest(webob.Request):
    ...
    def blank(cls, *args, **kwargs):
        ...
        out.environ['conveyor.context'] = FakeRequestContext(
            fake.USER_ID,
            fake.PROJECT_ID,
